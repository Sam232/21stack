  ...
  return (
    <div id="home">
      <nav className="navbar navbar-expand-lg right navbar-light bg-light">
        <a className="navbar-brand font-weight-bold" href="#home"><span><i className="fas fa-code"></i></span> 21stStack</a>
        ...
        <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div className="navbar-nav ml-auto">
            ...
            <a className="nav-item nav-link font-weight-bold" href="#testimony">Testimony</a>
